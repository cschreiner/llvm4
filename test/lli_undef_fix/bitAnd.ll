...
; Test bitwise and capabilities, twice under conditions should not generate
...
define i32 @main() {   ; i32()*
  ...
  %result1= and i8 56, 37 ; 0x38 & 0x25 = 32 = 0x20 
  %result2= and i8 178, 7 ; should be 2

  ; Call puts function to write out the string to stdout.
  call i32 (i8*, ...) @printf(i8* %unpoison_st_i8, i8 %result1 )
  call i32 (i8*, ...) @printf(i8* %unpoison_st_i8, i8 %result2 )

  %poisoned_1= add i8 122, 7
  %poison_result= and 3, %poisoned_1
