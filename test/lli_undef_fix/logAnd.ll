...
define i32 @main() {   ; i32()*
  ...
  %poison_result_u1p0= and i1 1, %poisoned_0
  call i32 (i8*, ...) @printf(i8* %poison_st_i8, i8 %poison_result_u1p0 )
  %poison_result_p0u1= and i1 %poisoned_0, 1
  call i32 (i8*, ...) @printf(i8* %poison_st_i8, i8 %poison_result_p0u1 )

  %poison_result_u0p0= and i1 0, %poisoned_0
  call i32 (i8*, ...) @printf(i8* %poison_st_i8, i8 %poison_result_u0p0 )
  %poison_result_p0u0= and i1 %poisoned_0, 0
  call i32 (i8*, ...) @printf(i8* %poison_st_i8, i8 %poison_result_p0u0 )

  %poison_result_u1p1= and i1 1, %poisoned_1
  call i32 (i8*, ...) @printf(i8* %poison_st_i8, i8 %poison_result_u1p1 )
  %poison_result_p1u1= and i1 %poisoned_1, 1
  call i32 (i8*, ...) @printf(i8* %poison_st_i8, i8 %poison_result_p1u1 )
