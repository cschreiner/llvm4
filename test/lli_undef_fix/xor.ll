...
; poison, once under conditions that would generate poison if banned
...
; -----------------------------------------------------------------------------
  ...
  call i32 (i8*, ...) @printf(i8* %unpoison_st_i8, i1 %result_u0u0 ) 
  %result_u0p0= xor i1 0, %poisoned_0
  call i32 (i8*, ...) @printf(i8* %poison_st_i8, i1 %result_u0p0 )
  %result_p0u0= xor i1 %poisoned_0, 0
  call i32 (i8*, ...) @printf(i8* %poison_st_i8, i1 %result_p0u0 )
  ...
  call i32 (i8*, ...) @printf(i8* %poison_st_i8, i1 %result_p1u0 )
